...
import parts.lost.calculationsystem.core.extensions.builder.StandardPusherBuilderExtension;
import parts.lost.calculationsystem.core.types.Generator;

public class GeneratorBuilderExtension extends StandardPusherBuilderExtension<Generator> {
    @Override
    public boolean accept(Flag flag) {
        return flag.isGenerator();
    }
}
