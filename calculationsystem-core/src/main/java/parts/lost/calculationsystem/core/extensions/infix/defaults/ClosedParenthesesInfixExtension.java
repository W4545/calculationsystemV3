 ...
 */
package parts.lost.calculationsystem.core.extensions.infix.defaults;
...
public class ClosedParenthesesInfixExtension implements InfixExtension {
    @Override
    ...
    public boolean accept(Flag flag) {
        return flag.isCloseParentheses();
    }
}
