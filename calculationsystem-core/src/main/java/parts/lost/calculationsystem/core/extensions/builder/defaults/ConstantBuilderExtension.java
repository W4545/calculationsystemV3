...
public class ConstantBuilderExtension extends BuilderExtension<ConstantTemplate> {

    @Override
    public void action(ConstantTemplate object, Deque<TreeType> stack, State state) {
        stack.push(object.getConstant());
    }

    @Override
    public boolean accept(Flag flag) {
        return flag.isConstant();
    }
}
